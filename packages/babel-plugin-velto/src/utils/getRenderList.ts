import { Node, Identifier, ReturnStatement, isArrowFunctionExpression, isBlockStatement, isCallExpression, isFunctionExpression, isJSXElement, isJSXFragment, isMemberExpression, isReturnStatement, callExpression, Expression } from "@babel/types";
import { RuntimeHelper } from "../helper";
import { NodePath } from "@babel/traverse";

export function getRenderList(express: Expression, path: NodePath) {
