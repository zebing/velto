...
describe('ref', () => {
  ...
  describe('dependency tracking', () => {
    ...
    it('should trigger effects when value changes', async () => {
      const r = ref(1);
      let callCount = 0;
  ...
  describe('reactive behavior', () => {
    it('should trigger effects immediately after setValue', async () => {
      const r = ref(0);
      let triggered = false;
    ...
    it('should not trigger effects when setting same value', async () => {
      const r = ref(1);
      let callCount = 0;
      ...
      await new Promise(resolve => setTimeout(resolve));
      expect(callCount).toBe(0); // No triggers when setting same value (optimization implemented)
    });
  });
  ...
  describe('nested reactivity', () => {
    ...
    it('should work with nested watchers', async () => {
      const r = ref(1);
  ...
  describe('integration with other reactive utilities', () => {
    it('should work as source for watch', async () => {
      const r = ref('initial');
    ...
    it('should work in complex reactive chains', async () => {
